...
class Model
{
    ...
    {
        return $this->db->table($this->table)->getRow($sql);
    }

    public function insertId()
    {
        return $this->db->table($this->table)->insertId();

    }

    public function affectRows()
    {
        return $this->db->table($this->table)->affectRows();
    }

    public function getLastSql()
    {
        return $this->db->table($this->table)->getLastSql();

    }

    public function getAllSql()
    {
        return $this->db->table($this->table)->getAllSql();
    }
