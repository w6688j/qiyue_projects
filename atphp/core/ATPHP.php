...
class ATPHP
{
    ...
    public static function run()
    {
        ...
        //TODO  这里我一定要写入配置文件里面,,,,
        //检测用域名来判断模块---
//        $app_model = checkModel();
//        if ($app_model === false) {
//            //说明找不到模块
//            throw new ExceptionExt("找不到域名对应的模块");
//        }

        $ctrlClass = '\\app\\module\\' . MODULE_NAME . '\controller\\' . ucfirst($request->controller) . "Controller";
