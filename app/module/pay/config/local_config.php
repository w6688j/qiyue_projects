...
return array(
    ...
    'alipay' => [
        ...
        //同步跳转
        'return_url' => "http://pay.pp158.cn:8082/AlipayNotice/return_url",
        //支付宝网关
    ...
    'weixin_app' => [
        //异步通知地址
        'notify_url' => "http://pay.pp158.cn:8082/WeixinNoticeApp/notify_url",
...
//    ],
    ...
    'heepay' => [
        ...
        'version' => 1,
        //异步通知地址
        'notify_url' => "http://pay.pp158.cn:8082/HeePayNotice/notify_url",
        //同步跳转
        'return_url' => "http://pay.pp158.cn:8082/HeePayNotice/return_url",
    ],
